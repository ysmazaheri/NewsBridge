    ...
    [
        {
            ...
            summary: "This is a summary of the exclusive report from The New York Times.",
            content: "This is the full content of the exclusive report from The New York Times.",

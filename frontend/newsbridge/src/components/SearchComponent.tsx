...
const SearchComponent = () => {
    ...
    const [selectedSortOption, setSelectedSortOption] = useState<string>("relevance");
    ...
    const [isBiasRatingDropdownOpen, setIsBiasRatingDropdown] = useState<boolean>(false);
    ...
    const handleDropdownToggle = (setter: React.Dispatch<React.SetStateAction<boolean>>, value: boolean) => {
        ...
        <div className="bg-white p-5 mt-5 w-full max-w-3xl mx-auto">
          <div className="flex flex-col space-y-4">
            ...
            {/* Posted at Dropdown */}
              ...
              toggleDropdown={handleDropdownToggle(setIsPostedAtDropdown, !isPostedAtDropdownOpen)}
            ...
            <Dropdown
              ...
              toggleDropdown={handleDropdownToggle(setIsCategoryDropdown, !isCategoryDropdownOpen)}
            ...
            />
              ...
              toggleDropdown={handleDropdownToggle(setIsBiasRatingDropdown, !isBiasRatingDropdownOpen)}
            ...
            />
              ...
              toggleDropdown={handleDropdownToggle(setIsSortDropdown, !isSortDropdownOpen)}
              ref = {sortDropdownRef}
